...
from deebot_client.commands.json.map import (  # noqa: I001
    GetCachedMapInfo,
    GetMajorMap,
    GetMapInfoV2,
    GetMapSetV2,
...
# 兼容层：按名称解析 LifeSpan，过滤掉当前库版本不支持的成员
_LIFE_SPAN_NAMES = (
    "BRUSH",
    "CLEANING_SOLUTION",
    "DUST_BAG",
...
_LIFE_SPANS = tuple(
    getattr(LifeSpan, _name)
    for _name in _LIFE_SPAN_NAMES
    if hasattr(LifeSpan, _name)
)
